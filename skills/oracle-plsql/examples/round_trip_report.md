...
Fixture edges: 54 = FACT 51, INFERRED 3, UNVERIFIABLE 0
...
| POLADM.PKG_POLICY_RENEWAL | POLADM.POLICY | writes |  [UPDATE] |
| POLADM.PKG_POLICY_RENEWAL | POLADM.PREMIUM_TXN | writes |  [INSERT] |
...
| POLADM.09_MRG_POLICY_FROM_STG | POLADM.POLICY | writes |  [DELETE|INSERT|UPDATE] |
...
| POLADM.PKG_POLICY_RENEWAL | POLADM.POLICY_AUDIT_LOG | writes | trigger fan-out via POLADM.TRG_POLICY_BIU -> POLADM.PRC_LOG_EVENT [INSERT] |
