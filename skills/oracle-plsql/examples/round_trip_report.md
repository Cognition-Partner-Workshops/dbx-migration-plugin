...
| ODS.PKG_POLICY_INQUIRY.GET_PARTY_CLAIMS | PACKAGE FUNCTION | pkg_policy_inquiry.sql | {"signature": "(VARCHAR2)"} |
| ODS.PKG_POLICY_INQUIRY.GET_POLICY_SUMMARY | PACKAGE FUNCTION | pkg_policy_inquiry.sql | {"signature": "(VARCHAR2)"} |
...
| POLADM.PKG_POLICY_RENEWAL.ARCHIVE_TO | PACKAGE PROCEDURE | 08_pkg_policy_renewal.sql | {"signature": "(VARCHAR2,NUMBER)"} |
| POLADM.PKG_POLICY_RENEWAL.BROKER_UPLIFT | PACKAGE FUNCTION | 08_pkg_policy_renewal.sql | {"signature": "(NUMBER)"} |
| POLADM.PKG_POLICY_RENEWAL.EXPIRING_CURSOR | PACKAGE FUNCTION | 08_pkg_policy_renewal.sql | {"signature": "(DATE,NUMBER)"} |
| POLADM.PKG_POLICY_RENEWAL.RENEW_EXPIRING | PACKAGE PROCEDURE | 08_pkg_policy_renewal.sql | {"signature": "(DATE?,NUMBER?,NUMBER?,NUMBER,VARCHAR2)"} |
