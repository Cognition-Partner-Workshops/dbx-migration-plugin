...
_TABLE_HEADER = "| wave | batch | unit | status | recon_verdict | verifier_verdict | pr_url | recon_cost |"
_TABLE_DIVIDER = "|---|---|---|---|---|---|---|---|"
        ...
        for batch in result.get("batches", []):
            ...
            for unit in units:
                rows.append((
                    ...
                    _text(batch_id),
                    _text(unit),
                    verifier_verdict if isinstance(unit_verdicts, dict) and batch_id in unit_verdicts
