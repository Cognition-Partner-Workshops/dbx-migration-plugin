...
| Catalog/schema layout, grants, row filters, column masks, lineage, system tables (`1-migration_setup`, governance steps of playbooks 2, 4 and 8, D8) | `databricks-unity-catalog` | Securable DDL, access control, fine-grained access, external locations, volumes, system tables for evidence. |
