...
Tolerance switches (`accept_marker_only_window`, `pk_set_stream_every_range`) must be JSON
booleans; `"false"`, `0` or `null` are rejected rather than coerced.
